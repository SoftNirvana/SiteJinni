...
<BODY>
                <?php
                    ...
                    if($client != NULL) {
                        //$companyloc->CompanyAddress = $client->
                    }
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {	
                            ...
                            if(isset($_POST['descDataFld']) && (isset($_FILES['amenityImageFile']) || isset($_POST['hdnFoaClass']))) {
                                    $amenityDescription = $_POST['descDataFld'];
                                    $amenityIcon = $_POST['hdnFoaClass'];
