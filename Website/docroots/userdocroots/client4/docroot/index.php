    ...
    <?php
		...
		if ($_SERVER["REQUEST_METHOD"] == "POST") {	
			...
			//----------------------------------------------------------------------------------------
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST" || $toSaveWithoutPost == TRUE) {
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <form action="index.php" method="post">
                                            <?php 
                                                echo 'Main Header <br><input type="text" id="header" name="header" style="width: 100%" ' . ($pageDesign->allParts['Header']!=NULL?'value="' . $pageDesign->allParts['Header']->Header . '"':"") . ' ><br>';
                                            ?>
